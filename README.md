...
- **Salary Check** — compares PSIPOP, GSIS billing, and payfile monthly salaries against each other.
- **Remittance Check (Recon)** — reconciles GSIS loan and premium billing against RDED/Payfile deductions and ERF remittance.
